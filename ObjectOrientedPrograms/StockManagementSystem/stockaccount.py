...
class StockAccount(companyshares.CompanyShares):
    ...
    def __init__(self, file, *args, **kwargs):
        ...
        self.company_listings = companyshares.CompanyShares.generate_company(self)  # generate list of company objects

    def stock_account(self): 
        """
        Description: 
            This function is used to get account data from json file.
        Pararmeter:
    ...
    def value_of(self):
        """
        Description: 
            This function is used to get the total value of the portfolio.
        Pararmeter:
            self is an instance of the object.
        Return:
    ...
    def buy(self):
        """
        Description: 
            This function is used to buy the shares.
        Pararmeter:
            self is an instance of the object.
        """

        print("Available Stocks :\n\nStock Name \t\tNumber\t\tPrice/Share\n")
        for company_obj in self.company_listings:
            print(f"{company_obj.symbol}\t\t\t{company_obj.number_of_shares}\t\t{company_obj.price}")
        ...
        for company_obj in self.company_listings:
            for user_stock in self.account['stock']:
                ...
                if (user_input == company_obj.symbol) and (user_input == user_stock['stockname']):
                    user_share = int(input("Number of Shares You would like to purchase? :\t"))
                    if user_share > company_obj.number_of_shares:
                        ...
                        company_obj.number_of_shares -= user_share  # Reduce stocks available in company
                        company_obj.get_transaction_time()  # Transaction time of the operation
                        print(f"\nTransaction time ===> {company_obj.transaction_time}\n")
                        print("==============Company============")
                        print(f"{company_obj.symbol}\t\t\t{company_obj.number_of_shares}\t\t{company_obj.price}")
                        print("==============Customer============")
        ...
        if in_file is False:  # If company name does not exist, create new company object
            ...
            self.company_listings.append(companyshares.CompanyShares(name_of_company, number_of_shares, price_per_share))  # Add company obj to company listings
            ...
            if user_share > temp.number_of_shares:
                ...
                data['stockname'] = name_of_company
                data['numberofshares'] = user_share
                data['shareprice'] = price_per_share
                ...
                test = self.account['stock'][-1]  
                print(f"Transaction time ====> {temp.transaction_time}") # Used temp var for displaying Transaction details
                print("==============Company============")
    ...
    def sell(self):
        """
        Description: 
            This function is used to sell the stocks to company.
        Pararmeter:
            self is an instance of the object.
        """
          # Sell stocks to company, if company not present in list, add company to list
        ...
        for company_obj in self.company_listings:
            for user_stock in self.account['stock']:
                ...
                if (user_sell == company_obj.symbol) and (user_sell == user_stock['stockname']):
                    ...
                    if sell_num > user_stock['numberofshares']:
                        ...
                        company_obj.number_of_shares += sell_num  # Update company stocks
                        company_obj.get_transaction_time()
        ...
        if in_file is False:  # If company doesnt exist, create company object for user
            ...
            data = dict()
            data['stockname'] = name_of_company
            data['numberofshares'] = number_of_shares
            data['shareprice'] = price_per_share
            ...
            if sell_share > self.account["stock"][-1]['numberofshares']:
                ...
                self.company_listings.append(companyshares.CompanyShares(name_of_company , sell_share, price_per_share ))
    ...
    def save_file(self):
        """
        Description: 
            This function is used to Save Changes to json files.
        Pararmeter:
            self is an instance of the object.
        """
    ...
    def print_report(self): 
        """
        Description: 
            This function is used to Print the report of Customers's Portfolio.
        Pararmeter:
            self is an instance of the object.
        """
